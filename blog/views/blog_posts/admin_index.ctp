<div class="blogPosts index">
	...
	<table cellpadding="0" cellspacing="0">
		<tr>
			...
			<th><?php echo $this->Paginator->sort('short_text_fre');?></th>			
			<th><?php echo $this->Paginator->sort('short_text_eng');?></th>			
			<th><?php echo $this->Paginator->sort('text_fre');?></th>			
			<th><?php echo $this->Paginator->sort('text_eng');?></th>			
			...
			foreach ($blogPosts as $blogPost) {
				...
				?>
					<tr<?php echo $class;?>>
						...
						<td class="short_text_fre"><?php echo $text->truncate($blogPost['BlogPost']['short_text_fre'], 150, array('exact' => false)); ?>&nbsp;</td>
						<td class="short_text_eng"><?php echo $text->truncate($blogPost['BlogPost']['short_text_eng'], 150, array('exact' => false)); ?>&nbsp;</td>
						<td class="text_fre"><?php echo $text->truncate($blogPost['BlogPost']['text_fre'], 150, array('exact' => false)); ?>&nbsp;</td>
						<td class="text_eng"><?php echo $text->truncate($blogPost['BlogPost']['text_eng'], 150, array('exact' => false)); ?>&nbsp;</td>
						<td class="multimedia"><?php echo $this->Multimedia->img($blogPost['BlogPost']['multimedia'], array('method'=>'crop','size'=>'80x80')); ?></td>
						<td class="actions">
