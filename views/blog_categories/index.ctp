			...
			foreach ($blogCategories as $blogCategory) {
				...
				?>
					<tr<?php echo $class;?>>
						...
						<td class="title"><?php echo $blogCategory['BlogCategory']['title']; ?>&nbsp;</td>
						<td class="desc"><?php echo $blogCategory['BlogCategory']['desc']; ?>&nbsp;</td>
						<td class="actions">
							<?php echo $this->Html->link(__('View', true), array('action' => 'view', $blogCategory['BlogCategory']['id']), array('class' => 'view')); ?>
						</td>
					</tr>
				<?php
			}
